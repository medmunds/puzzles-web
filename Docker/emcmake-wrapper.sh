#!/bin/bash
# emcmake wrapper installed in build-wasm container, to keep CLion happy.
#
...
#    - set Image to an image built from build-wasm.Dockerfile
...
#    - adjust any other options you want (see the emcmake command in build-wasm.sh)
